  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:collaborator => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested collaborator" do
        collaborator = Collaborator.create! valid_attributes
        put :update, {:id => collaborator.to_param, :collaborator => new_attributes}, valid_session
        collaborator.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        collaborator = Collaborator.create! valid_attributes
        put :update, {:id => collaborator.to_param, :collaborator => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
